...
Source0  : https://www.stunnel.org/downloads/stunnel-5.74.tar.gz
Source1  : https://www.stunnel.org/downloads/stunnel-5.74.tar.gz.asc
...
%setup -q -n stunnel-5.74
cd %{_builddir}/stunnel-5.74
%patch -P 1 -p1
pushd ..
cp -a stunnel-5.74 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745275825
